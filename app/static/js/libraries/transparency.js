...
})(
  {
    1: [
      function (require, module, exports) {
        ...
        Transparency.render = function (context, models, directives, options) {
          ...
          context =
            (base = helpers.data(context)).context ||
            (base.context = new Context(context, Transparency))
        ...
        Transparency.matcher = function (element, key) {
          return (
            element.el.id === key ||
            indexOf.call(element.classNames, key) >= 0 ||
            element.el.name === key ||
        ...
        Transparency.jQueryPlugin = helpers.chainable(function (
          models,
          directives,
          options
        ) {
    ...
    3: [
      function (require, module, exports) {
        ...
        (before = ref.before),
        (after = ref.after),
        (chainable = ref.chainable),
        (cloneNode = ref.cloneNode)
        ...
        module.exports = Context = (function () {
          ...
          Context.prototype.render = before(detach)(
            after(attach)(
              chainable(function (models, directives, options) {
                ...
                while (models.length > this.instances.length) {
                  instance =
                    ...
                    new Instance(cloneNode(this.template), this.Transparency)
      ...
      function (require, module, exports) {
        ...
        module.exports = ElementFactory = {
          ...
          createElement: function (el) {
            var El, name
            if ((name = el.nodeName.toLowerCase()) === 'input') {
        ...
        Element = (function () {
          ...
          Element.prototype.attr = function (name, value) {
            var attribute, base
            attribute =
              (base = this.attributes)[name] ||
              (base[name] = AttributeFactory.createAttribute(
                this.el,
                name,
                value
              ))
          ...
          Element.prototype.renderDirectives = function (
            model,
            index,
            attributes
          ) {
    ...
    5: [
      function (require, module, exports) {
        ...
        exports.cloneNode =
          typeof document === 'undefined' || document === null || html5Clone()
            ? function (node) {
    ...
    6: [
      function (require, module, exports) {
        ...
        module.exports = Instance = (function () {
          ...
          Instance.prototype.renderValues = chainable(function (
            model,
            children
          ) {
          ...
          Instance.prototype.renderDirectives = chainable(function (
            model,
            index,
            directives
          ) {
          ...
          Instance.prototype.renderChildren = chainable(function (
            model,
            children,
            directives,
            options
    ...
    7: [
      function (require, module, exports) {
        ...
        _.isPlainValue = function (obj) {
          ...
          type = typeof obj
          return (
            (type !== 'object' && type !== 'function') || exports.isDate(obj)
          )
        }
